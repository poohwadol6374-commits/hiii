...
export default function OnboardingPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center px-4 py-12 bg-white dark:bg-lumina-950">
      ...
      <motion.div
        className="pointer-events-none absolute left-1/4 top-1/4 h-72 w-72 rounded-full bg-google-blue-100/25 blur-3xl"
        animate={{ x: [0, 30, 0], y: [0, -20, 0], scale: [1, 1.1, 1] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="pointer-events-none absolute bottom-1/4 right-1/4 h-64 w-64 rounded-full bg-google-green-100/20 blur-3xl"
        animate={{ x: [0, -25, 0], y: [0, 25, 0], scale: [1, 1.15, 1] }}
        transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="pointer-events-none absolute top-1/3 right-1/3 h-48 w-48 rounded-full bg-google-yellow-100/15 blur-3xl"
      ...
      <div className="relative z-10 flex w-full max-w-lg flex-col items-center">
        ...
        >
          <motion.div
            className="absolute inset-0 rounded-full bg-google-blue-400/15 blur-xl"
